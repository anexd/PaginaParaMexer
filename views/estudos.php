    <section id="corpo">
            <article id="noticiaprincipal">
                <h2> Como processamento de imagens pode ajudar  na agricultura</h2>
                
                
                <p>  Existem muitas vantagens para agricultura ao usar técnicas de processamento de imagens tais   como detecção de pragas em colheitas,
                cobertura do solo, automatização de seleção de frutas por tamanho , cor , peso e manchas e entre outras coisas.</p>
